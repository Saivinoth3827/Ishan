        ...
        <div style={styles.paymentContainer}>
          ...
          <div style={styles.orderSummary}>
            <img
              ...
              src="https://assets.winni.in/product/primary/2021/10/55075.png?dpr=1&w=400x"
              alt="Product Image"
            />
            <h3 style={styles.orderSummaryTitle}>Signature Style Couple Necklace</h3>
            <p>
              Offers <a href="#">Add Code</a>
            </p>
            <p>Order: $60.00</p>
            <p>Delivery: $2.00</p>
            <p style={styles.orderSummaryTotal}>Total: $62.00</p>
            <p>
